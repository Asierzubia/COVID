...
void calculate_metric_mean()
{
    ...
    printf("[METRICAS]: Despues de calcular media por nodo (num_batch : %d) -> %6.4lf - %6.4lf - %6.4lf - %6.4lf - %6.4lf \n", num_batch, l_metrics[0], l_metrics[1], l_metrics[2], l_metrics[3], l_metrics[4]);
}
